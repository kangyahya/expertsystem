...
@section('content')
  ...
  <a class="btn btn-primary mb-4" href="{{route('data-aturan.create')}}">
    Tambah Data
  </a>
  ...
  <div class="modal fade" id="addAturan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-floating form-floating-outline mb-4">
              <select name="symptom_id[]" id="symptom_id" multiple class="form-select">
  ...
  @foreach($aturan as $atur)
    ...
    <div class="modal fade" id="hapusAturan{{$atur->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <form method="post" action="{{route('data-aturan.destroy', $atur->id)}}">
        @method('DELETE')
        @csrf
        <div class="modal-dialog">
          <div class="modal-content">
